...
> = {
  checking:    { icon: Building2,   color: 'text-blue-600',    bg: 'bg-blue-100',    label: 'accounts.typeChecking' },
  savings:     { icon: PiggyBank,   color: 'text-emerald-600', bg: 'bg-emerald-100', label: 'accounts.typeSavings' },
  credit_card: { icon: CreditCard,  color: 'text-cyan-600',    bg: 'bg-cyan-100',    label: 'accounts.typeCreditCard' },
